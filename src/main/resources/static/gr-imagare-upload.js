...
(function () {
  ...
  Polymer({
    ...
    attached() {
      ...
      this.$.dragDropArea.addEventListener('paste', e => e.preventDefault(), false);

      this._getUserPreferences();
    },

    detached() {
      window.removeEventListener('dragover', e => e.preventDefault(), false);
      window.removeEventListener('drop', e => e.preventDefault(), false);
      this.$.dragDropArea.removeEventListener('paste', e => e.preventDefault(), false);
    },
